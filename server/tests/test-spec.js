    ...
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          ...
          .equal('User with that EMAIL already exist');
        done();
      });
  });
  ...
  it('It should allow registered users to login', done => {
    ...
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          .to.have.property('message')
          .equal('Authentication Successful');
        expect(res.body)
          .to.have.property('token')
          .to.be.a('string');
  ...
  it('It should respond with an error if user does not exists', done => {
    ...
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          .to.have.property('error')
          .equal('Invalid password or email');
        done();
      });
  });
...
describe('/POST messages', () => {
  ...
  it('Should return an error if reciever does not exist', done => {
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          .to.have.property('error')
          .equal('Recipient is not a registered member');
        done();
      });
  });
  ...
  it('It should respond with an error if user credentials are incorrect', done => {
    ...
    chai
      ...
      .send({
        subject: '',
        message: 'You are now an Udacity Mentor',
        receiverId: 'admin@epicmail.com'
      })
      .end((err, res) => {
        expect(err).to.be.null;
        res.should.have.status(400);
  ...
  it('should get all received emails', done => {
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          .to.have.property('message')
          .equal('All received emails retrieved');
        expect(res.body).to.be.an('object');
        expect(res.body)
          .to.have.property('data')
          .to.be.an('array');
  ...
  it('should get all received unread emails', done => {
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          .to.have.property('message')
          .equal('Email retrieved successfully');
        expect(res.body)
          .to.have.property('data')
          .to.be.an('array');
        done();
  ...
  it('should get all sent emails', done => {
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          .to.have.property('message')
          .equal('All sent emails retrieved');
        expect(res.body)
          .to.have.property('data')
          .to.be.an('array');
        done();
  ...
  it('should delete an email', done => {
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          .to.have.property('message')
          .equal('Email deleted successfully');
        done();
      });
  });
  ...
  it('retrieve all created groups', done => {
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          .to.have.property('message')
          .equal('All created groups retrieved successfully');
        done();
      });
  });
...
describe('/PATCH update group name', () => {
  it('check for wrong group id', done => {
    // using chai-http plugin
    chai
      .request(app)
  ...
  it('check if group exists', done => {
    ...
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          .to.have.property('error')
          .equal('Invalid Group ID Supplied/Only Admin can update Group');
        done();
      });
  });
  ...
  it('It should return an error for wrong groupid ', done => {
    ...
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          .to.have.property('error')
          .equal('Invalid Group ID Supplied/Only Admin can delete Group');
        done();
      });
  });
});
